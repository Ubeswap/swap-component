...
exports.default = (0, react_1.memo)(function SwapRoute({ trade }) {
    ...
    const path = trade instanceof trade_1.MinimaRouterTrade || trade instanceof trade_1.UbeswapTrade ? trade.path : trade.route.path;
