...
export default function Transaction({ hash }) {
    ...
    if (!chainId)
        return null;
    return (_jsx(TransactionWrapper, { children: _jsxs(TransactionState, Object.assign({ href: `${network.explorer}/tx/${hash}`, pending: pending, success: success }, { children: [_jsx(RowFixed, { children: _jsxs(TransactionStatusText, { children: [summary !== null && summary !== void 0 ? summary : hash, " \u2197"] }, void 0) }, void 0), _jsx(IconWrapper, Object.assign({ pending: pending, success: success }, { children: pending ? _jsx(Loader, {}, void 0) : success ? _jsx(CheckCircle, { size: "16" }, void 0) : _jsx(Triangle, { size: "16" }, void 0) }), void 0)] }), void 0) }, void 0));
}
