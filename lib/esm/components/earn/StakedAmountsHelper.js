...
export default function StakedAmountsHelper({ userAmountTokenA, userAmountTokenB }) {
    return _jsx(QuestionHelper, { text: `${formatStakedAmount(userAmountTokenA)} | ${formatStakedAmount(userAmountTokenB)}` }, void 0);
}
export function SingleStakedAmountsHelper({ userAmountToken }) {
    return _jsx(QuestionHelper, { text: `${formatStakedAmount(userAmountToken)}` }, void 0);
}
