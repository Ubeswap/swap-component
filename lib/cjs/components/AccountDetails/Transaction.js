...
function Transaction({ hash }) {
    ...
    if (!chainId)
        return null;
    return ((0, jsx_runtime_1.jsx)(TransactionWrapper, { children: (0, jsx_runtime_1.jsxs)(TransactionState, Object.assign({ href: `${network.explorer}/tx/${hash}`, pending: pending, success: success }, { children: [(0, jsx_runtime_1.jsx)(Row_1.RowFixed, { children: (0, jsx_runtime_1.jsxs)(TransactionStatusText, { children: [summary !== null && summary !== void 0 ? summary : hash, " \u2197"] }) }), (0, jsx_runtime_1.jsx)(IconWrapper, Object.assign({ pending: pending, success: success }, { children: pending ? (0, jsx_runtime_1.jsx)(Loader_1.default, {}) : success ? (0, jsx_runtime_1.jsx)(react_feather_1.CheckCircle, { size: "16" }) : (0, jsx_runtime_1.jsx)(react_feather_1.Triangle, { size: "16" }) }))] })) }));
}
