...
import { Field, replaceSwapState, selectCurrency, setAccountInfo, setRecipient, switchCurrencies, typeInput, } from './actions';
const initialState = {
...
export default createReducer(initialState, (builder) => builder
    ...
    return Object.assign(Object.assign({}, state), { 
        ...
        [Field.INPUT]: { currencyId: state[Field.OUTPUT].currencyId }, [Field.OUTPUT]: { currencyId: state[Field.INPUT].currencyId } });
})
    ...
    .addCase(setAccountInfo, (state, { payload: { accountInfo } }) => {
