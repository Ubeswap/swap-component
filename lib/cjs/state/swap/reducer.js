...
exports.default = (0, toolkit_1.createReducer)(initialState, (builder) => builder
    ...
    return Object.assign(Object.assign({}, state), { independentField: state.independentField === actions_1.Field.INPUT ? actions_1.Field.OUTPUT : actions_1.Field.INPUT, [actions_1.Field.INPUT]: { currencyId: state[actions_1.Field.OUTPUT].currencyId }, [actions_1.Field.OUTPUT]: { currencyId: state[actions_1.Field.INPUT].currencyId } });
})
