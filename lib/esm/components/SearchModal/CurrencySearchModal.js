...
export default function CurrencySearchModal({ isOpen, onDismiss, onCurrencySelect, selectedCurrency, otherSelectedCurrency, showCommonBases = false, chainId, }) {
    ...
    return (_jsx(Modal, Object.assign({ isOpen: isOpen, onDismiss: onDismiss, maxHeight: 80, minHeight: minHeight }, { children: modalView === CurrencyModalView.search ? (_jsx(CurrencySearch, { isOpen: isOpen, onDismiss: onDismiss, onCurrencySelect: handleCurrencySelect, selectedCurrency: selectedCurrency, otherSelectedCurrency: otherSelectedCurrency, showCommonBases: showCommonBases, showImportView: () => setModalView(CurrencyModalView.importToken), setImportToken: setImportToken, showManageView: () => setModalView(CurrencyModalView.manage), chainId: chainId }, void 0)) : modalView === CurrencyModalView.importToken && importToken ? (_jsx(ImportToken, { tokens: [importToken], onDismiss: onDismiss, onBack: () => setModalView(prevView && prevView !== CurrencyModalView.importToken ? prevView : CurrencyModalView.search), handleCurrencySelect: handleCurrencySelect }, void 0)) : modalView === CurrencyModalView.importList && importList && listURL ? (_jsx(ImportList, { list: importList, listURL: listURL, onDismiss: onDismiss, setModalView: setModalView }, void 0)) : modalView === CurrencyModalView.manage ? (_jsx(Manage, { onDismiss: onDismiss, setModalView: setModalView, setImportToken: setImportToken, setImportList: setImportList, setListUrl: setListUrl }, void 0)) : ('') }), void 0));
}
