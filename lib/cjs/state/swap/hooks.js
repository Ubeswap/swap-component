...
function useDerivedSwapInfo(minimaPartnerId) {
    var _a, _b;
    ...
    const minimaBestTradeExactIn = (0, useTrade_1.useMinimaTrade)(isExactIn ? parsedAmount : undefined, outputCurrency !== null && outputCurrency !== void 0 ? outputCurrency : undefined, minimaPartnerId);
    ...
    if (balanceIn && amountIn && balanceIn.lessThan(amountIn)) {
        if (amountIn.currency.address === sdk_1.cUSD[chainId].address ||
            amountIn.currency.address === sdk_1.CELO[chainId].address ||
            amountIn.currency.address === sdk_1.cEUR[chainId].address) {
            showRamp = true;
        }
...
function useDefaultsFromURLSearch(defaultSwapToken) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        dispatch((0, actions_1.replaceSwapState)({
            ...
            inputCurrencyId: (0, utils_1.isAddress)(defaultSwapToken) ? defaultSwapToken : parsed[actions_1.Field.INPUT].currencyId,
