...
function ManageTokens({ setModalView, setImportToken, }) {
    ...
    const tokenList = (0, react_1.useMemo)(() => {
        return (chainId &&
            userAddedTokens.map((token) => ((0, jsx_runtime_1.jsxs)(Row_1.RowBetween, Object.assign({ width: "100%" }, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(CurrencyLogo_1.default, { currency: token, size: '20px' }), (0, jsx_runtime_1.jsx)(theme_1.ExternalLink, Object.assign({ href: `${explorerUrl}/address/${token.address}` }, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.main, Object.assign({ ml: '10px', fontWeight: 600 }, { children: token.symbol })) }))] }), (0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TrashIcon, { onClick: () => removeToken(chainId, token.address) }), (0, jsx_runtime_1.jsx)(theme_1.ExternalLinkIcon, { href: `${explorerUrl}/address/${token.address}` })] })] }), token.address))));
    }, [userAddedTokens, removeToken, network, chainId]);
    return ((0, jsx_runtime_1.jsxs)(Wrapper, { children: [(0, jsx_runtime_1.jsxs)(Column_1.default, Object.assign({ style: { width: '100%', flex: '1 1' } }, { children: [(0, jsx_runtime_1.jsxs)(styleds_1.PaddedColumn, Object.assign({ gap: "14px" }, { children: [(0, jsx_runtime_1.jsx)(Row_1.default, { children: (0, jsx_runtime_1.jsx)(styleds_1.SearchInput, { type: "text", id: "token-search-input", placeholder: '0x0000', value: searchQuery, autoComplete: "off", ref: inputRef, onChange: handleInput }) }), searchQuery !== '' && !isAddressSearch && ((0, jsx_runtime_1.jsx)(theme_1.TYPE.error, Object.assign({ error: true }, { children: t('EnterValidTokenAddress') }))), searchToken && ((0, jsx_runtime_1.jsx)(Card_1.default, Object.assign({ backgroundColor: theme.bg2, padding: "10px 0" }, { children: (0, jsx_runtime_1.jsx)(ImportRow_1.default, { token: searchToken, showImportView: () => setModalView(CurrencySearchModal_1.CurrencyModalView.importToken), setImportToken: setImportToken, style: { height: 'fit-content' } }) })))] })), (0, jsx_runtime_1.jsx)(styleds_1.Separator, {}), (0, jsx_runtime_1.jsxs)(styleds_1.PaddedColumn, Object.assign({ gap: "lg" }, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(theme_1.TYPE.main, Object.assign({ fontWeight: 600 }, { children: [userAddedTokens === null || userAddedTokens === void 0 ? void 0 : userAddedTokens.length, " ", t('Custom'), " ", userAddedTokens.length === 1 ? 'Token' : 'Tokens'] })), userAddedTokens.length > 0 && ((0, jsx_runtime_1.jsx)(theme_1.ButtonText, Object.assign({ onClick: handleRemoveAll }, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.blue, { children: t('ClearAll') }) })))] }), tokenList] }))] })), (0, jsx_runtime_1.jsx)(Footer, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.darkGray, { children: t('TipCustomTokensAreStoredLocallyInYourBrowser') }) })] }));
}
