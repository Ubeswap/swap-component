...
const white = '#FFFFFF';
const black = '#000000';
function colors(darkMode, primaryColor) {
    return {
        // base
        white,
        black,
...
function ThemeProvider({ children }) {
    const swapTheme = (0, hooks_1.useSwapTheme)();
    const themeObject = (0, react_1.useMemo)(() => theme(swapTheme), [swapTheme]);
