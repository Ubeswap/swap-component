...
function CurrencySearchModal({ isOpen, onDismiss, onCurrencySelect, selectedCurrency, otherSelectedCurrency, showCommonBases = false, chainId, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(Modal_1.default, Object.assign({ isOpen: isOpen, onDismiss: onDismiss, maxHeight: 80, minHeight: minHeight }, { children: modalView === CurrencyModalView.search ? ((0, jsx_runtime_1.jsx)(CurrencySearch_1.CurrencySearch, { isOpen: isOpen, onDismiss: onDismiss, onCurrencySelect: handleCurrencySelect, selectedCurrency: selectedCurrency, otherSelectedCurrency: otherSelectedCurrency, showCommonBases: showCommonBases, showImportView: () => setModalView(CurrencyModalView.importToken), setImportToken: setImportToken, showManageView: () => setModalView(CurrencyModalView.manage), chainId: chainId }, void 0)) : modalView === CurrencyModalView.importToken && importToken ? ((0, jsx_runtime_1.jsx)(ImportToken_1.ImportToken, { tokens: [importToken], onDismiss: onDismiss, onBack: () => setModalView(prevView && prevView !== CurrencyModalView.importToken ? prevView : CurrencyModalView.search), handleCurrencySelect: handleCurrencySelect }, void 0)) : modalView === CurrencyModalView.importList && importList && listURL ? ((0, jsx_runtime_1.jsx)(ImportList_1.ImportList, { list: importList, listURL: listURL, onDismiss: onDismiss, setModalView: setModalView }, void 0)) : modalView === CurrencyModalView.manage ? ((0, jsx_runtime_1.jsx)(Manage_1.default, { onDismiss: onDismiss, setModalView: setModalView, setImportToken: setImportToken, setImportList: setImportList, setListUrl: setListUrl }, void 0)) : ('') }), void 0));
}
