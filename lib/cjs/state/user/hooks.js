...
function useIsDarkMode() {
    const { userDarkMode, matchesDarkMode } = (0, react_redux_1.useSelector)(({ user: { matchesDarkMode, userDarkMode } }) => ({
        userDarkMode,
        matchesDarkMode,
...
function useDarkModeManager() {
    ...
    const toggleSetDarkMode = (0, react_1.useCallback)(() => {
        dispatch((0, actions_1.updateUserDarkMode)({ userDarkMode: !darkMode }));
    }, [darkMode, dispatch]);
