...
function DoubleCurrencyLogo({ currency0, currency1, size = 16, margin = false, }) {
    return ((0, jsx_runtime_1.jsxs)(Wrapper, Object.assign({ sizeraw: size, margin: margin }, { children: [currency0 && (0, jsx_runtime_1.jsx)(HigherLogo, { currency: currency0, size: size.toString() + 'px' }), currency1 && (0, jsx_runtime_1.jsx)(CoveredLogo, { currency: currency1, size: size.toString() + 'px', sizeraw: size })] })));
}
