...
function useApproveCallback(amountToApprove, spender) {
    ...
    const [minApprove] = (0, hooks_1.useUserMinApprove)();
    const currentAllowance = (0, Allowances_1.useTokenAllowance)(token, account !== null && account !== void 0 ? account : undefined, spender);
    const pendingApproval = (0, hooks_2.useHasPendingApproval)(token === null || token === void 0 ? void 0 : token.address, spender);
...
function useApproveCallbackFromTrade(trade, allowedSlippage = 0) {
    ...
    return useApproveCallback(amountToApprove, trade instanceof MoolaDirectTrade_1.MoolaDirectTrade
