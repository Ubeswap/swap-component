...
export function ExternalLink(_a) {
    ...
    return _jsx(StyledLink, Object.assign({ target: target, rel: rel, href: href, onClick: handleClick }, rest), void 0);
}
export function ExternalLinkIcon(_a) {
    ...
    return (_jsx(LinkIconWrapper, Object.assign({ target: target, rel: rel, href: href, onClick: handleClick }, rest, { children: _jsx(LinkIcon, {}, void 0) }), void 0));
}
...
export function BackArrow({ to }) {
    return (_jsx(BackArrowLink, Object.assign({ to: to }, { children: _jsx(ArrowLeft, {}, void 0) }), void 0));
}
