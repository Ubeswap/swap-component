...
export const TradeDetails = ({ trade, allowedSlippage }) => {
    ...
    if (routingMethod === RoutingMethod.MOOLA) {
        return _jsx(MoolaDirectTradeDetails, { trade: trade }, void 0);
    }
    if (routingMethod === RoutingMethod.MOOLA_ROUTER) {
        return _jsx(MoolaRouterTradeDetails, { trade: trade, allowedSlippage: allowedSlippage }, void 0);
    }
    return _jsx(UbeswapTradeDetails, { trade: trade, allowedSlippage: allowedSlippage }, void 0);
};
