...
const MoolaRouterTradeDetails = ({ trade, allowedSlippage }) => {
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(UbeswapTradeDetails_1.UbeswapTradeDetails, { trade: trade, allowedSlippage: allowedSlippage }) }));
};
