...
const MoolaDirectTradeDetails = ({ trade }) => {
    ...
    if (userData) {
        ...
        userDataArea = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Collateral Balance" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "The amount of collateral you have in Moola." })] }), (0, jsx_runtime_1.jsx)(Row_1.RowFixed, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: collateral ? (collateral.lessThan(new sdk_1.Fraction('1')) ? '<$1' : `$${collateral.toFixed(2)}`) : '--' })) })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Borrow Balance" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "The amount you owe to Moola." })] }), (0, jsx_runtime_1.jsx)(Row_1.RowFixed, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: borrows ? (borrows.lessThan(new sdk_1.Fraction('1')) ? '<$1' : `$${borrows.toFixed(2)}`) : '--' })) })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Health Factor" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "How risky your position is. If this is below 1, you can be liquidated." })] }), (0, jsx_runtime_1.jsx)(styleds_1.ErrorText, Object.assign({ fontWeight: 500, fontSize: 14, severity: 0 }, { children: healthFactor.gt(100) ? 'Excellent' : healthFactor.toString() }))] })] }));
    }
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsxs)(theme_1.TYPE.black, Object.assign({ fontSize: 14, fontWeight: 400, color: theme.text2 }, { children: [trade.outputAmount.currency.symbol, " received"] })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: `Since this trade is routed through Moola, you are guaranteed to receive 1 ${trade.outputAmount.currency.symbol} per ${trade.inputAmount.currency.symbol}.` })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14 }, { children: trade.outputAmount.lessThan('10000') ? trade.outputAmount.toSignificant(4) : trade.outputAmount.toFixed(0) })), (0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: trade.tradeType === sdk_1.TradeType.EXACT_INPUT
                                    ? trade.outputAmount.currency.symbol
                                    : trade.inputAmount.currency.symbol }))] })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Price Impact" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "Since this trade is routed through Moola, there is zero price slippage." })] }), (0, jsx_runtime_1.jsx)(styleds_1.ErrorText, Object.assign({ fontWeight: 500, fontSize: 14, severity: 0 }, { children: "0.00%" }))] }), userDataArea] }));
};
