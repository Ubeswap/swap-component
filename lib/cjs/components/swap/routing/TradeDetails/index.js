...
const TradeDetails = ({ trade, allowedSlippage }) => {
    ...
    if (routingMethod === describeTrade_1.RoutingMethod.MOOLA) {
        return (0, jsx_runtime_1.jsx)(MoolaDirectTradeDetails_1.MoolaDirectTradeDetails, { trade: trade });
    }
    if (routingMethod === describeTrade_1.RoutingMethod.MOOLA_ROUTER) {
        return (0, jsx_runtime_1.jsx)(MoolaRouterTradeDetails_1.MoolaRouterTradeDetails, { trade: trade, allowedSlippage: allowedSlippage });
    }
    return (0, jsx_runtime_1.jsx)(UbeswapTradeDetails_1.UbeswapTradeDetails, { trade: trade, allowedSlippage: allowedSlippage });
};
