...
const CurrencySearchModal_1 = __importDefault(require("components/SearchModal/CurrencySearchModal"));
...
function TokenSelect(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Aligner, { children: [(0, jsx_runtime_1.jsx)(CurrencySelect_1.CurrencySelect, Object.assign({ selected: !props.token, className: "open-currency-select-button", onClick: () => {
                            setModalOpen(true);
                        } }, { children: (0, jsx_runtime_1.jsx)(Aligner, { children: props.token ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(CurrencyLogo_1.default, { currency: props.token, size: '24px' }, void 0), (0, jsx_runtime_1.jsxs)(StyledTokenName, { children: [" ", props.token.symbol, " "] }, void 0)] }, void 0)) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faFilter, width: '16px' }, void 0), (0, jsx_runtime_1.jsx)(StyledTokenName, { children: t('Token') }, void 0)] }, void 0)) }, void 0) }), void 0), props.token && ((0, jsx_runtime_1.jsx)(CloseIcon, Object.assign({ onClick: () => props.onTokenSelect(null) }, { children: (0, jsx_runtime_1.jsx)(CloseColor, {}, void 0) }), void 0))] }, void 0), (0, jsx_runtime_1.jsx)(CurrencySearchModal_1.default, { isOpen: modalOpen, onDismiss: handleDismissSearch, onCurrencySelect: props.onTokenSelect, selectedCurrency: props === null || props === void 0 ? void 0 : props.token, showCommonBases: true }, void 0)] }, void 0));
}
