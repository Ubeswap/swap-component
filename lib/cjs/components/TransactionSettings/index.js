...
function SlippageTabs({ rawSlippage, setRawSlippage, deadline, setDeadline }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Column_1.AutoColumn, Object.assign({ gap: "md" }, { children: [(0, jsx_runtime_1.jsxs)(Column_1.AutoColumn, Object.assign({ gap: "sm" }, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontWeight: 400, fontSize: 14, color: theme.text2 }, { children: "Slippage tolerance" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "Your transaction will revert if the price changes unfavorably by more than this percentage." })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsx)(Option, Object.assign({ onClick: () => {
                                    setSlippageInput('');
                                    setRawSlippage(10);
                                }, active: rawSlippage === 10 }, { children: "0.1%" })), (0, jsx_runtime_1.jsx)(Option, Object.assign({ onClick: () => {
                                    setSlippageInput('');
                                    setRawSlippage(50);
                                }, active: rawSlippage === 50 }, { children: "0.5%" })), (0, jsx_runtime_1.jsx)(Option, Object.assign({ onClick: () => {
                                    setSlippageInput('');
                                    setRawSlippage(100);
                                }, active: rawSlippage === 100 }, { children: "1%" })), (0, jsx_runtime_1.jsx)(OptionCustom, Object.assign({ active: ![10, 50, 100].includes(rawSlippage), warning: !slippageInputIsValid, tabIndex: -1 }, { children: (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [!!slippageInput &&
                                            (slippageError === SlippageError.RiskyLow || slippageError === SlippageError.RiskyHigh) ? ((0, jsx_runtime_1.jsx)(SlippageEmojiContainer, { children: (0, jsx_runtime_1.jsx)("span", Object.assign({ role: "img", "aria-label": "warning" }, { children: "\u26A0\uFE0F" })) })) : null, (0, jsx_runtime_1.jsx)(Input, { ref: inputRef, placeholder: (rawSlippage / 100).toFixed(2), value: slippageInput, onBlur: () => {
                                                parseCustomSlippage((rawSlippage / 100).toFixed(2));
                                            }, onChange: (e) => parseCustomSlippage(e.target.value), color: !slippageInputIsValid ? 'red' : '' }), "%"] }) }))] }), !!slippageError && ((0, jsx_runtime_1.jsx)(Row_1.RowBetween, Object.assign({ style: {
                            fontSize: '14px',
                            paddingTop: '7px',
                            ...
                            : slippageError === SlippageError.RiskyLow
                                ...
                                : 'Your transaction may be frontrun' })))] })), (0, jsx_runtime_1.jsxs)(Column_1.AutoColumn, Object.assign({ gap: "sm" }, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, fontWeight: 400, color: theme.text2 }, { children: "Transaction deadline" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "Your transaction will revert if it is pending for more than this long." })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(OptionCustom, Object.assign({ style: { width: '80px' }, tabIndex: -1 }, { children: (0, jsx_runtime_1.jsx)(Input, { color: deadlineError ? 'red' : undefined, onBlur: () => {
                                        parseCustomDeadline((deadline / 60).toString());
                                    }, placeholder: (deadline / 60).toString(), value: deadlineInput, onChange: (e) => parseCustomDeadline(e.target.value) }) })), (0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ style: { paddingLeft: '8px' }, fontSize: 14 }, { children: "minutes" }))] })] }))] })));
}
