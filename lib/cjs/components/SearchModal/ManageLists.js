...
const ListRow = (0, react_1.memo)(function ListRow({ listUrl }) {
    ...
    if (!list)
        return null;
    return ((0, jsx_runtime_1.jsxs)(RowWrapper, Object.assign({ active: isActive, bgColor: listColor, id: listUrlRowHTMLId(listUrl) }, { children: [list.logoURI ? ((0, jsx_runtime_1.jsx)(ListLogo_1.default, { size: "40px", style: { marginRight: '1rem' }, logoURI: list.logoURI, alt: `${list.name} list logo` })) : ((0, jsx_runtime_1.jsx)("div", { style: { width: '24px', height: '24px', marginRight: '1rem' } })), (0, jsx_runtime_1.jsxs)(Column_1.default, Object.assign({ style: { flex: '1' } }, { children: [(0, jsx_runtime_1.jsx)(Row_1.default, { children: (0, jsx_runtime_1.jsx)(StyledTitleText, Object.assign({ active: isActive }, { children: list.name })) }), (0, jsx_runtime_1.jsxs)(Row_1.RowFixed, Object.assign({ mt: "4px" }, { children: [(0, jsx_runtime_1.jsxs)(StyledListUrlText, Object.assign({ active: isActive, mr: "6px" }, { children: [list.tokens.length, " tokens"] })), (0, jsx_runtime_1.jsxs)(StyledMenu, Object.assign({ ref: node }, { children: [(0, jsx_runtime_1.jsx)(Button_1.ButtonEmpty, Object.assign({ onClick: toggle, ref: setReferenceElement, padding: "0" }, { children: (0, jsx_runtime_1.jsx)(react_feather_1.Settings, { stroke: isActive ? theme.bg1 : theme.text1, size: 12 }) })), open && ((0, jsx_runtime_1.jsxs)(PopoverContainer, Object.assign({ show: true, ref: setPopperElement, style: styles.popper }, attributes.popper, { children: [(0, jsx_runtime_1.jsx)("div", { children: list && (0, listVersionLabel_1.default)(list.version) }), (0, jsx_runtime_1.jsx)(styleds_1.SeparatorDark, {}), (0, jsx_runtime_1.jsx)(theme_1.ExternalLink, Object.assign({ href: `https://tokenlists.org/token-list?url=${listUrl}` }, { children: "View list" })), (0, jsx_runtime_1.jsx)(UnpaddedLinkStyledButton, Object.assign({ onClick: handleRemoveList, disabled: Object.keys(listsByUrl).length === 1 }, { children: "Remove list" })), pending && ((0, jsx_runtime_1.jsx)(UnpaddedLinkStyledButton, Object.assign({ onClick: handleAcceptListUpdate }, { children: "Update list" })))] })))] }))] }))] })), (0, jsx_runtime_1.jsx)(ListToggle_1.default, { isActive: isActive, bgColor: listColor, toggle: () => {
...
function ManageLists({ setModalView, setImportList, setListUrl, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Wrapper, { children: [(0, jsx_runtime_1.jsxs)(styleds_1.PaddedColumn, Object.assign({ gap: "14px" }, { children: [(0, jsx_runtime_1.jsx)(Row_1.default, { children: (0, jsx_runtime_1.jsx)(styleds_1.SearchInput, { type: "text", id: "list-add-input", placeholder: "https:// or ipfs:// or ENS name", value: listUrlInput, onChange: handleInput }) }), addError ? ((0, jsx_runtime_1.jsx)(theme_1.TYPE.error, Object.assign({ title: addError, style: { textOverflow: 'ellipsis', overflow: 'hidden' }, error: true }, { children: addError }))) : null] })), tempList && ((0, jsx_runtime_1.jsx)(styleds_1.PaddedColumn, Object.assign({ style: { paddingTop: 0 } }, { children: (0, jsx_runtime_1.jsx)(Card_1.default, Object.assign({ backgroundColor: theme.bg2, padding: "12px 20px" }, { children: (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [tempList.logoURI && (0, jsx_runtime_1.jsx)(ListLogo_1.default, { logoURI: tempList.logoURI, size: "40px" }), (0, jsx_runtime_1.jsxs)(Column_1.AutoColumn, Object.assign({ gap: "4px", style: { marginLeft: '20px' } }, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ fontWeight: 600 }, { children: tempList.name })), (0, jsx_runtime_1.jsxs)(theme_1.TYPE.main, Object.assign({ fontSize: '12px' }, { children: [tempList.tokens.length, " tokens"] }))] }))] }), isImported ? ((0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.IconWrapper, Object.assign({ stroke: theme.text2, size: "16px", marginRight: '10px' }, { children: (0, jsx_runtime_1.jsx)(react_feather_1.CheckCircle, {}) })), (0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ color: theme.text2 }, { children: "Loaded" }))] })) : ((0, jsx_runtime_1.jsx)(Button_1.ButtonPrimary, Object.assign({ style: { fontSize: '14px' }, padding: "6px 8px", width: "fit-content", onClick: handleImport }, { children: "Import" })))] }) })) }))), (0, jsx_runtime_1.jsx)(styleds_1.Separator, {}), (0, jsx_runtime_1.jsx)(ListContainer, { children: (0, jsx_runtime_1.jsx)(Column_1.AutoColumn, Object.assign({ gap: "md" }, { children: sortedLists.map((listUrl) => ((0, jsx_runtime_1.jsx)(ListRow, { listUrl: listUrl }, listUrl))) })) })] }));
}
