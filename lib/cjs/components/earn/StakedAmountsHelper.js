...
function StakedAmountsHelper({ userAmountTokenA, userAmountTokenB }) {
    return (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: `${formatStakedAmount(userAmountTokenA)} | ${formatStakedAmount(userAmountTokenB)}` });
}
exports.default = StakedAmountsHelper;
function SingleStakedAmountsHelper({ userAmountToken }) {
    return (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: `${formatStakedAmount(userAmountToken)}` });
}
