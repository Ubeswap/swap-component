...
import { addSerializedPair, addSerializedToken, removeSerializedToken, toggleURLWarning, updateUserAllowMoolaWithdrawal, updateUserDeadline, updateUserDisableSmartRouting, updateUserExpertMode, updateUserMinApprove, updateUserSingleHopOnly, updateUserSlippageTolerance, } from './actions';
...
export function useSwapTheme() {
    const { theme } = useSelector(({ user: { theme } }) => ({
        theme,
    }), shallowEqual);
    return theme;
}
