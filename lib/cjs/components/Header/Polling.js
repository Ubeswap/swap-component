...
function Polling() {
    ...
    return ((0, jsx_runtime_1.jsx)(theme_1.ExternalLink, Object.assign({ href: chainId && blockNumber ? `${explorerUrl}/blocks` : '' }, { children: (0, jsx_runtime_1.jsxs)(StyledPolling, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.small, Object.assign({ style: { opacity: isMounted ? '0.2' : '0.6' } }, { children: blockNumber })), (0, jsx_runtime_1.jsx)(StyledPollingDot, { children: !isMounted && (0, jsx_runtime_1.jsx)(Spinner, {}) })] }) })));
}
