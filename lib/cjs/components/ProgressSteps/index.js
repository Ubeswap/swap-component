...
function ProgressCircles(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Wrapper, Object.assign({ justify: 'center' }, rest, { children: (0, jsx_runtime_1.jsxs)(Grouping, { children: [steps.map((step, i) => {
                    return ((0, jsx_runtime_1.jsxs)(CircleRow, { children: [(0, jsx_runtime_1.jsx)(Circle, Object.assign({ confirmed: step, disabled: disabled || (!steps[i - 1] && i !== 0) }, { children: step ? '✓' : i + 1 }), void 0), (0, jsx_runtime_1.jsx)(Connector, { prevConfirmed: step, disabled: disabled }, void 0)] }, i));
                }), (0, jsx_runtime_1.jsx)(Circle, Object.assign({ disabled: disabled || !steps[steps.length - 1] }, { children: steps.length + 1 }), void 0)] }, void 0) }), void 0));
}
