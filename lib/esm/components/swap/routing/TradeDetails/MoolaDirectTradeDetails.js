...
export const MoolaDirectTradeDetails = ({ trade }) => {
    ...
    if (userData) {
        ...
        userDataArea = (_jsxs(_Fragment, { children: [_jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [_jsx(TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Collateral Balance" }), void 0), _jsx(QuestionHelper, { text: "The amount of collateral you have in Moola." }, void 0)] }, void 0), _jsx(RowFixed, { children: _jsx(TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: collateral ? (collateral.lessThan(new Fraction('1')) ? '<$1' : `$${collateral.toFixed(2)}`) : '--' }), void 0) }, void 0)] }, void 0), _jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [_jsx(TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Borrow Balance" }), void 0), _jsx(QuestionHelper, { text: "The amount you owe to Moola." }, void 0)] }, void 0), _jsx(RowFixed, { children: _jsx(TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: borrows ? (borrows.lessThan(new Fraction('1')) ? '<$1' : `$${borrows.toFixed(2)}`) : '--' }), void 0) }, void 0)] }, void 0), _jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [_jsx(TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Health Factor" }), void 0), _jsx(QuestionHelper, { text: "How risky your position is. If this is below 1, you can be liquidated." }, void 0)] }, void 0), _jsx(ErrorText, Object.assign({ fontWeight: 500, fontSize: 14, severity: 0 }, { children: healthFactor.gt(100) ? 'Excellent' : healthFactor.toString() }), void 0)] }, void 0)] }, void 0));
    }
    return (_jsxs(_Fragment, { children: [_jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [_jsxs(TYPE.black, Object.assign({ fontSize: 14, fontWeight: 400, color: theme.text2 }, { children: [trade.outputAmount.currency.symbol, " received"] }), void 0), _jsx(QuestionHelper, { text: `Since this trade is routed through Moola, you are guaranteed to receive 1 ${trade.outputAmount.currency.symbol} per ${trade.inputAmount.currency.symbol}.` }, void 0)] }, void 0), _jsxs(RowFixed, { children: [_jsx(TYPE.black, Object.assign({ fontSize: 14 }, { children: trade.outputAmount.lessThan('10000') ? trade.outputAmount.toSignificant(4) : trade.outputAmount.toFixed(0) }), void 0), _jsx(TYPE.black, Object.assign({ fontSize: 14, marginLeft: '4px' }, { children: trade.tradeType === TradeType.EXACT_INPUT
                                    ? trade.outputAmount.currency.symbol
                                    : trade.inputAmount.currency.symbol }), void 0)] }, void 0)] }, void 0), _jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [_jsx(TYPE.black, Object.assign({ color: theme.text2, fontSize: 14, fontWeight: 400 }, { children: "Price Impact" }), void 0), _jsx(QuestionHelper, { text: "Since this trade is routed through Moola, there is zero price slippage." }, void 0)] }, void 0), _jsx(ErrorText, Object.assign({ fontWeight: 500, fontSize: 14, severity: 0 }, { children: "0.00%" }), void 0)] }, void 0), userDataArea] }, void 0));
};
