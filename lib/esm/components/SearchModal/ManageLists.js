...
const ListRow = memo(function ListRow({ listUrl }) {
    ...
    if (!list)
        return null;
    return (_jsxs(RowWrapper, Object.assign({ active: isActive, bgColor: listColor, id: listUrlRowHTMLId(listUrl) }, { children: [list.logoURI ? (_jsx(ListLogo, { size: "40px", style: { marginRight: '1rem' }, logoURI: list.logoURI, alt: `${list.name} list logo` }, void 0)) : (_jsx("div", { style: { width: '24px', height: '24px', marginRight: '1rem' } }, void 0)), _jsxs(Column, Object.assign({ style: { flex: '1' } }, { children: [_jsx(Row, { children: _jsx(StyledTitleText, Object.assign({ active: isActive }, { children: list.name }), void 0) }, void 0), _jsxs(RowFixed, Object.assign({ mt: "4px" }, { children: [_jsxs(StyledListUrlText, Object.assign({ active: isActive, mr: "6px" }, { children: [list.tokens.length, " tokens"] }), void 0), _jsxs(StyledMenu, Object.assign({ ref: node }, { children: [_jsx(ButtonEmpty, Object.assign({ onClick: toggle, ref: setReferenceElement, padding: "0" }, { children: _jsx(Settings, { stroke: isActive ? theme.bg1 : theme.text1, size: 12 }, void 0) }), void 0), open && (_jsxs(PopoverContainer, Object.assign({ show: true, ref: setPopperElement, style: styles.popper }, attributes.popper, { children: [_jsx("div", { children: list && listVersionLabel(list.version) }, void 0), _jsx(SeparatorDark, {}, void 0), _jsx(ExternalLink, Object.assign({ href: `https://tokenlists.org/token-list?url=${listUrl}` }, { children: "View list" }), void 0), _jsx(UnpaddedLinkStyledButton, Object.assign({ onClick: handleRemoveList, disabled: Object.keys(listsByUrl).length === 1 }, { children: "Remove list" }), void 0), pending && (_jsx(UnpaddedLinkStyledButton, Object.assign({ onClick: handleAcceptListUpdate }, { children: "Update list" }), void 0))] }), void 0))] }), void 0)] }), void 0)] }), void 0), _jsx(ListToggle, { isActive: isActive, bgColor: listColor, toggle: () => {
...
export function ManageLists({ setModalView, setImportList, setListUrl, }) {
    ...
    return (_jsxs(Wrapper, { children: [_jsxs(PaddedColumn, Object.assign({ gap: "14px" }, { children: [_jsx(Row, { children: _jsx(SearchInput, { type: "text", id: "list-add-input", placeholder: "https:// or ipfs:// or ENS name", value: listUrlInput, onChange: handleInput }, void 0) }, void 0), addError ? (_jsx(TYPE.error, Object.assign({ title: addError, style: { textOverflow: 'ellipsis', overflow: 'hidden' }, error: true }, { children: addError }), void 0)) : null] }), void 0), tempList && (_jsx(PaddedColumn, Object.assign({ style: { paddingTop: 0 } }, { children: _jsx(Card, Object.assign({ backgroundColor: theme.bg2, padding: "12px 20px" }, { children: _jsxs(RowBetween, { children: [_jsxs(RowFixed, { children: [tempList.logoURI && _jsx(ListLogo, { logoURI: tempList.logoURI, size: "40px" }, void 0), _jsxs(AutoColumn, Object.assign({ gap: "4px", style: { marginLeft: '20px' } }, { children: [_jsx(TYPE.body, Object.assign({ fontWeight: 600 }, { children: tempList.name }), void 0), _jsxs(TYPE.main, Object.assign({ fontSize: '12px' }, { children: [tempList.tokens.length, " tokens"] }), void 0)] }), void 0)] }, void 0), isImported ? (_jsxs(RowFixed, { children: [_jsx(IconWrapper, Object.assign({ stroke: theme.text2, size: "16px", marginRight: '10px' }, { children: _jsx(CheckCircle, {}, void 0) }), void 0), _jsx(TYPE.body, Object.assign({ color: theme.text2 }, { children: "Loaded" }), void 0)] }, void 0)) : (_jsx(ButtonPrimary, Object.assign({ style: { fontSize: '14px' }, padding: "6px 8px", width: "fit-content", onClick: handleImport }, { children: "Import" }), void 0))] }, void 0) }), void 0) }), void 0)), _jsx(Separator, {}, void 0), _jsx(ListContainer, { children: _jsx(AutoColumn, Object.assign({ gap: "md" }, { children: sortedLists.map((listUrl) => (_jsx(ListRow, { listUrl: listUrl }, listUrl))) }), void 0) }, void 0)] }, void 0));
}
