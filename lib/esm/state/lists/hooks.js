...
export function useCombinedActiveList(defaultTokenLists) {
    ...
    const defaultTokenMap = listToTokenMap(defaultTokenLists
        ? Object.assign(Object.assign({}, UBESWAP_TOKEN_LIST), { tokens: defaultTokenLists }) : Object.assign(Object.assign({}, UBESWAP_TOKEN_LIST), UNISWAP_TOKEN_LIST));
