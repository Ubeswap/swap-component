...
function Balance({ balance }) {
    return (0, jsx_runtime_1.jsx)(StyledBalanceText, Object.assign({ title: balance.toExact() }, { children: balance.toSignificant(4) }), void 0);
}
...
function TokenTags({ currency }) {
    ...
    if (!tags || tags.length === 0)
        return (0, jsx_runtime_1.jsx)("span", {}, void 0);
    const tag = tags[0];
    return ((0, jsx_runtime_1.jsxs)(TagContainer, { children: [(0, jsx_runtime_1.jsx)(Tooltip_1.MouseoverTooltip, Object.assign({ text: tag.description }, { children: (0, jsx_runtime_1.jsx)(Tag, { children: tag.name }, tag.id) }), void 0), tags.length > 1 ? ((0, jsx_runtime_1.jsx)(Tooltip_1.MouseoverTooltip, Object.assign({ text: tags
                    .slice(1)
                    .map(({ name, description }) => `${name}: ${description}`)
                    .join('; \n') }, { children: (0, jsx_runtime_1.jsx)(Tag, { children: "..." }, void 0) }), void 0)) : null] }, void 0));
}
function CurrencyRow({ currency, onSelect, isSelected, otherSelected, style, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(styleds_1.MenuItem, Object.assign({ style: style, className: `token-item-${key}`, onClick: () => (isSelected ? null : onSelect()), disabled: isSelected, selected: otherSelected }, { children: [(0, jsx_runtime_1.jsx)(CurrencyLogo_1.default, { currency: currency, size: '24px' }, void 0), (0, jsx_runtime_1.jsxs)(Column_1.default, { children: [(0, jsx_runtime_1.jsx)(rebass_1.Text, Object.assign({ title: currency.name, fontWeight: 500 }, { children: currency.symbol }), void 0), (0, jsx_runtime_1.jsxs)(theme_1.TYPE.darkGray, Object.assign({ ml: "0px", fontSize: '12px', fontWeight: 300 }, { children: [currency.name, " ", !isOnSelectedList && customAdded && '• Added by user'] }), void 0)] }, void 0), (0, jsx_runtime_1.jsx)(TokenTags, { currency: currency }, void 0), (0, jsx_runtime_1.jsx)(Row_1.RowFixed, Object.assign({ style: { justifySelf: 'flex-end' } }, { children: balance ? (0, jsx_runtime_1.jsx)(Balance, { balance: balance }, void 0) : account ? (0, jsx_runtime_1.jsx)(Loader_1.default, {}, void 0) : null }), void 0)] }), void 0));
}
function CurrencyList({ height, currencies, selectedCurrency, onCurrencySelect, otherCurrency, fixedListRef, showImportView, setImportToken, }) {
    ...
    const Row = (0, react_1.useCallback)(({ data, index, style }) => {
        ...
        if (showImport && token) {
            return ((0, jsx_runtime_1.jsx)(ImportRow_1.default, { style: style, token: token, showImportView: showImportView, setImportToken: setImportToken, dim: true }, void 0));
        }
        else {
            return ((0, jsx_runtime_1.jsx)(CurrencyRow, { style: style, currency: currency, isSelected: isSelected, onSelect: handleSelect, otherSelected: otherSelected }, void 0));
        }
    ...
    return ((0, jsx_runtime_1.jsx)(react_window_1.FixedSizeList, Object.assign({ height: height, ref: fixedListRef, width: "100%", itemData: itemData, itemCount: itemData.length, itemSize: 56, itemKey: itemKey }, { children: Row }), void 0));
}
