...
function PopupItem({ removeAfterMs, content, popKey, }) {
    ...
    if ('txn' in content) {
        ...
        popupContent = (0, jsx_runtime_1.jsx)(TransactionPopup_1.default, { hash: hash, success: success, summary: summary });
    }
    else if ('listUpdate' in content) {
        const { listUpdate: { listUrl, oldList, newList, auto }, } = content;
        popupContent = (0, jsx_runtime_1.jsx)(ListUpdatePopup_1.default, { popKey: popKey, listUrl: listUrl, oldList: oldList, newList: newList, auto: auto });
    }
    ...
    return ((0, jsx_runtime_1.jsxs)(exports.Popup, { children: [(0, jsx_runtime_1.jsx)(exports.StyledClose, { color: theme.text2, onClick: removeThisPopup }), popupContent, removeAfterMs !== null ? (0, jsx_runtime_1.jsx)(AnimatedFader, { style: faderStyle }) : null] }));
}
