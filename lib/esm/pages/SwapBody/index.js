...
export default function SwapBody({ useDarkMode }) {
    ...
    const { v2Trade, currencyBalances, parsedAmount, currencies, inputError: swapInputError, showRamp, } = useDerivedSwapInfo();
    ...
    return (_jsxs(_Fragment, { children: [_jsx(TokenWarningModal, { isOpen: importTokensNotInDefault.length > 0 && !dismissTokenWarning, tokens: importTokensNotInDefault, onConfirm: handleConfirmTokenWarning }, void 0), _jsx(OpticsV1Warning, {}, void 0), _jsx(SwapPoolTabs, { active: 'swap' }, void 0), _jsxs(AppBody, { children: [_jsx(SwapHeader, { title: actionLabel }, void 0), _jsxs(Wrapper, Object.assign({ id: "swap-page" }, { children: [_jsx(ConfirmSwapModal, { isOpen: showConfirm, trade: trade, originalTrade: tradeToConfirm, onAcceptChanges: handleAcceptChanges, attemptingTxn: attemptingTxn, txHash: txHash, recipient: recipient, allowedSlippage: allowedSlippage, onConfirm: handleSwap, swapErrorMessage: swapErrorMessage, onDismiss: handleConfirmDismiss }, void 0), _jsxs(AutoColumn, Object.assign({ gap: 'md' }, { children: [_jsx(CurrencyInputPanel, { label: independentField === Field.OUTPUT && trade
                                            ? `${t('from')}${isEstimate ? ' (estimated)' : ''}`
                                            : t('from'), value: formattedAmounts[Field.INPUT], showMaxButton: !atMaxAmountInput, showHalfButton: !atHalfAmountInput, currency: currencies[Field.INPUT], onUserInput: handleTypeInput, onMax: handleMaxInput, onHalf: handleHalfInput, onCurrencySelect: handleInputSelect, otherCurrency: currencies[Field.OUTPUT], id: "swap-currency-input" }, void 0), _jsx(AutoColumn, Object.assign({ justify: "space-between" }, { children: _jsxs(AutoRow, Object.assign({ justify: isExpertMode ? 'space-between' : 'center', style: { padding: '0 1rem' } }, { children: [_jsx(ArrowWrapper, Object.assign({ clickable: true }, { children: _jsx(ArrowDown, { size: "16", onClick: () => {
                                                            setApprovalSubmitted(false); // reset 2 step UI for approvals
                                                            onSwitchTokens();
                                                        }, color: currencies[Field.INPUT] && currencies[Field.OUTPUT] ? theme.primary1 : theme.text2 }, void 0) }), void 0), recipient === null && isExpertMode ? (_jsx(LinkStyledButton, Object.assign({ id: "add-recipient-button", onClick: () => onChangeRecipient('') }, { children: "+ Add a send (optional)" }), void 0)) : null] }), void 0) }), void 0), _jsx(CurrencyInputPanel, { value: formattedAmounts[Field.OUTPUT], onUserInput: handleTypeOutput, label: independentField === Field.INPUT && trade ? `${t('to')}${isEstimate ? ' (estimated)' : ''}` : t('to'), showMaxButton: false, currency: currencies[Field.OUTPUT], onCurrencySelect: handleOutputSelect, otherCurrency: currencies[Field.INPUT], id: "swap-currency-output" }, void 0), recipient !== null ? (_jsxs(_Fragment, { children: [_jsxs(AutoRow, Object.assign({ justify: "space-between", style: { padding: '0 1rem' } }, { children: [_jsx(ArrowWrapper, Object.assign({ clickable: false }, { children: _jsx(ArrowDown, { size: "16", color: theme.text2 }, void 0) }), void 0), _jsx(LinkStyledButton, Object.assign({ id: "remove-recipient-button", onClick: () => onChangeRecipient(null) }, { children: "- Remove send" }), void 0)] }), void 0), _jsx(AddressInputPanel, { id: "recipient", value: recipient, onChange: onChangeRecipient }, void 0)] }, void 0)) : null, _jsx(Card, Object.assign({ padding: '0px', borderRadius: '20px' }, { children: _jsxs(AutoColumn, Object.assign({ gap: "8px", style: { padding: '0 16px' } }, { children: [Boolean(trade) && (_jsxs(RowBetween, Object.assign({ align: "center" }, { children: [_jsx(Text, Object.assign({ fontWeight: 500, fontSize: 14, color: theme.text2 }, { children: "Price" }), void 0), _jsx(TradePrice, { price: trade === null || trade === void 0 ? void 0 : trade.executionPrice, showInverted: showInverted, setShowInverted: setShowInverted }, void 0)] }), void 0)), allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (_jsxs(RowBetween, Object.assign({ align: "center" }, { children: [_jsx(ClickableText, Object.assign({ fontWeight: 500, fontSize: 14, color: theme.text2, onClick: toggleSettings }, { children: "Slippage Tolerance" }), void 0), _jsxs(ClickableText, Object.assign({ fontWeight: 500, fontSize: 14, color: theme.text2, onClick: toggleSettings }, { children: [allowedSlippage / 100, "%"] }), void 0)] }), void 0))] }), void 0) }), void 0)] }), void 0), _jsxs(BottomGrouping, { children: [swapIsUnsupported ? (_jsx(ButtonPrimary, Object.assign({ disabled: true }, { children: _jsx(TYPE.main, Object.assign({ mb: "4px" }, { children: "Unsupported Asset" }), void 0) }), void 0)) : !account ? (_jsx(ButtonLight, Object.assign({ onClick: toggleWalletModal }, { children: t('connectWallet') }), void 0)) : noRoute && userHasSpecifiedInputOutput ? (_jsxs(GreyCard, Object.assign({ style: { textAlign: 'center' } }, { children: [_jsx(TYPE.main, Object.assign({ mb: "4px" }, { children: "Insufficient liquidity for this trade." }), void 0), singleHopOnly && _jsx(TYPE.main, Object.assign({ mb: "4px" }, { children: "Try enabling multi-hop trades." }), void 0)] }), void 0)) : showRamp ? (_jsxs(ButtonLight, Object.assign({ onClick: () => {
                                            var _a;
                                            new RampInstantSDK({
                                                hostAppName: 'Ubeswap',
                                        ...
                                        } }, { children: ["Get more ", (_g = currencies.INPUT) === null || _g === void 0 ? void 0 : _g.symbol, " via Ramp"] }), void 0)) : showApproveFlow ? (_jsxs(RowBetween, { children: [_jsx(ButtonConfirmed, Object.assign({ onClick: approveCallback, disabled: approval !== ApprovalState.NOT_APPROVED || approvalSubmitted, width: "48%", altDisabledStyle: approval === ApprovalState.PENDING, confirmed: approval === ApprovalState.APPROVED }, { children: approval === ApprovalState.PENDING ? (_jsxs(AutoRow, Object.assign({ gap: "6px", justify: "center" }, { children: ["Approving ", _jsx(Loader, { stroke: "white" }, void 0)] }), void 0)) : approvalSubmitted && approval === ApprovalState.APPROVED ? ('Approved') : ('Approve ' + ((_h = currencies[Field.INPUT]) === null || _h === void 0 ? void 0 : _h.symbol)) }), void 0), _jsx(ButtonError, Object.assign({ onClick: () => {
                                                    if (isExpertMode) {
                                                        handleSwap();
                                                    }
                                                    else {
                                                        ...
                                                        ? `Price Impact High`
                                                        : `${actionLabel}${priceImpactSeverity > 2 ? ' Anyway' : ''}` }), void 0) }), void 0)] }, void 0)) : (_jsx(ButtonError, Object.assign({ onClick: () => {
                                            if (isExpertMode) {
                                                handleSwap();
                                            }
                                            else {
                                                ...
                                                : priceImpactSeverity > 3 && !isExpertMode
                                                    ...
                                                    : `${actionLabel}${priceImpactSeverity > 2 ? ' Anyway' : ''}` }), void 0) }), void 0)), showApproveFlow && (_jsx(Column, Object.assign({ style: { marginTop: '1rem' } }, { children: _jsx(ProgressSteps, { steps: [approval === ApprovalState.APPROVED] }, void 0) }), void 0)), isExpertMode && swapErrorMessage ? _jsx(SwapCallbackError, { error: swapErrorMessage }, void 0) : null] }, void 0)] }), void 0)] }, void 0), !swapIsUnsupported ? (_jsx(AdvancedSwapDetailsDropdown, { trade: trade }, void 0)) : (_jsx(UnsupportedCurrencyFooter, { show: swapIsUnsupported, currencies: [currencies.INPUT, currencies.OUTPUT] }, void 0))] }, void 0));
}
