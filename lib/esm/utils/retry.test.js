...
describe('retry', () => {
    ...
    it('fails for non-retryable error', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry(makeFn(1, 'abc', false), { n: 3, maxWait: 0, minWait: 0 }).promise).rejects.toThrow('bad failure');
    }));
    it('works after one fail', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry(makeFn(1, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).resolves.toEqual('abc');
    }));
    it('works after two fails', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry(makeFn(2, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).resolves.toEqual('abc');
    }));
    it('throws if too many fails', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry(makeFn(4, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).rejects.toThrow('failure');
    }));
