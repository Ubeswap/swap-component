...
function ListUpdatePopup({ popKey, listUrl, oldList, newList, auto, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(Row_1.AutoRow, { children: (0, jsx_runtime_1.jsx)(Column_1.AutoColumn, Object.assign({ style: { flex: '1' }, gap: "8px" }, { children: auto ? ((0, jsx_runtime_1.jsxs)(theme_1.TYPE.body, Object.assign({ fontWeight: 500 }, { children: [t('TheTokenList'), " \"", oldList.name, "\" ", t('HasBeenUpdatedTo'), ' ', (0, jsx_runtime_1.jsx)("strong", { children: (0, listVersionLabel_1.default)(newList.version) }, void 0), "."] }), void 0)) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)(rebass_1.Text, { children: [t('AnUpdateIsAvailableForTheTokenList'), " \"", oldList.name, "\" (", (0, listVersionLabel_1.default)(oldList.version), " to ", (0, listVersionLabel_1.default)(newList.version), ")."] }, void 0), (0, jsx_runtime_1.jsxs)(exports.ChangesList, { children: [tokensAdded.length > 0 ? ((0, jsx_runtime_1.jsxs)("li", { children: [tokensAdded.map((token, i) => ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)("strong", Object.assign({ title: token.address }, { children: token.symbol }), void 0), i === tokensAdded.length - 1 ? null : ', '] }, `${token.chainId}-${token.address}`))), ' ', t('Added')] }, void 0)) : null, tokensRemoved.length > 0 ? ((0, jsx_runtime_1.jsxs)("li", { children: [tokensRemoved.map((token, i) => ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)("strong", Object.assign({ title: token.address }, { children: token.symbol }), void 0), i === tokensRemoved.length - 1 ? null : ', '] }, `${token.chainId}-${token.address}`))), ' ', t('Removed')] }, void 0)) : null, numTokensChanged > 0 ? ((0, jsx_runtime_1.jsxs)("li", { children: [numTokensChanged, " ", t('TokensUpdated')] }, void 0)) : null] }, void 0)] }, void 0), (0, jsx_runtime_1.jsxs)(Row_1.AutoRow, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ style: { flexGrow: 1, marginRight: 12 } }, { children: (0, jsx_runtime_1.jsx)(Button_1.ButtonSecondary, Object.assign({ onClick: handleAcceptUpdate }, { children: t('AcceptUpdate') }), void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ style: { flexGrow: 1 } }, { children: (0, jsx_runtime_1.jsx)(Button_1.ButtonSecondary, Object.assign({ onClick: removeThisPopup }, { children: t('Dismiss') }), void 0) }), void 0)] }, void 0)] }, void 0)) }), void 0) }, void 0));
}
