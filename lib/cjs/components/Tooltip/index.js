...
function Tooltip(_a) {
    ...
    return (0, jsx_runtime_1.jsx)(Popover_1.default, Object.assign({ content: (0, jsx_runtime_1.jsx)(TooltipContainer, { children: text }) }, rest));
}
...
function MouseoverTooltip(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Tooltip, Object.assign({}, rest, { show: show }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ onMouseEnter: open, onMouseLeave: close }, { children: children })) })));
}
