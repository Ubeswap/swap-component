...
function useMinimaTrade(tokenAmountIn, tokenOut, minimaPartnerId) {
    ...
    const provider = (0, utils_1.getProviderOrSigner)(accountInfo ? accountInfo.provider : library, account || undefined);
    ...
    const call = react_1.default.useCallback(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield fetch(`${index_1.MINIMA_API_URL}?exclude=${index_1.DEXES_TO_EXCLUDE}&tokenIn=${(_a = tokenAmountIn === null || tokenAmountIn === void 0 ? void 0 : tokenAmountIn.currency.address) !== null && _a !== void 0 ? _a : ''}&tokenOut=${(_b = tokenOut === null || tokenOut === void 0 ? void 0 : tokenOut.address) !== null && _b !== void 0 ? _b : ''}&amountIn=${tokenAmountIn === null || tokenAmountIn === void 0 ? void 0 : tokenAmountIn.raw}&slippage=${allowedSlippage}&maxHops=${singleHopOnly ? 1 : MAX_HOPS}&includeTxn=true&priceImpact=true${account ? '&from=' + account : ''}`, {
            method: 'GET',
            headers: {
