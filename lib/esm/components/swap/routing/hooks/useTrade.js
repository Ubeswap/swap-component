...
import { BASES_TO_CHECK_TRADES_AGAINST, BETTER_TRADE_LESS_HOPS_THRESHOLD, FETCH_MINIMA_ROUTER_TIMER, MINIMA_API_URL, UBESWAP_MOOLA_ROUTER_ADDRESS, } from '../../../../constants/index';
...
export function useMinimaTrade(tokenAmountIn, tokenOut) {
    ...
    const call = React.useCallback(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield fetch(`${MINIMA_API_URL}?tokenIn=${(_a = tokenAmountIn === null || tokenAmountIn === void 0 ? void 0 : tokenAmountIn.currency.address) !== null && _a !== void 0 ? _a : ''}&tokenOut=${(_b = tokenOut === null || tokenOut === void 0 ? void 0 : tokenOut.address) !== null && _b !== void 0 ? _b : ''}&amountIn=${tokenAmountIn === null || tokenAmountIn === void 0 ? void 0 : tokenAmountIn.raw}&slippage=${allowedSlippage}&maxHops=${singleHopOnly ? 1 : MAX_HOPS}&includeTxn=true&priceImpact=true${account ? '&from=' + account : ''}`, {
            method: 'GET',
            headers: {
