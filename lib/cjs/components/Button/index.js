...
exports.ButtonLight = (0, styled_components_2.default)(Base) `
  ...
  font-weight: 500;
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme, disabled }) => !disabled && (0, polished_1.darken)(0.03, theme.primary5)};
    background-color: ${({ theme, disabled }) => !disabled && (0, polished_1.darken)(0.03, theme.primary5)};
  }
  &:hover {
    background-color: ${({ theme, disabled }) => !disabled && (0, polished_1.darken)(0.03, theme.primary5)};
  }
  &:active {
    box-shadow: 0 0 0 1pt ${({ theme, disabled }) => !disabled && (0, polished_1.darken)(0.05, theme.primary5)};
    background-color: ${({ theme, disabled }) => !disabled && (0, polished_1.darken)(0.05, theme.primary5)};
  }
  :disabled {
    opacity: 0.4;
    :hover {
...
function ButtonConfirmed(_a) {
    ...
    if (confirmed) {
        return (0, jsx_runtime_1.jsx)(ButtonConfirmedStyle, Object.assign({}, rest), void 0);
    }
    else {
        return (0, jsx_runtime_1.jsx)(exports.ButtonPrimary, Object.assign({}, rest, { altDisabledStyle: altDisabledStyle }), void 0);
    }
}
...
function ButtonError(_a) {
    ...
    if (error) {
        return (0, jsx_runtime_1.jsx)(ButtonErrorStyle, Object.assign({}, rest), void 0);
    }
    else {
        return (0, jsx_runtime_1.jsx)(exports.ButtonPrimary, Object.assign({}, rest), void 0);
    }
}
exports.ButtonError = ButtonError;
function ButtonDropdown(_a) {
    var { disabled = false, children } = _a, rest = __rest(_a, ["disabled", "children"]);
    return ((0, jsx_runtime_1.jsx)(exports.ButtonPrimary, Object.assign({}, rest, { disabled: disabled }, { children: (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ style: { display: 'flex', alignItems: 'center' } }, { children: children }), void 0), (0, jsx_runtime_1.jsx)(react_feather_1.ChevronDown, { size: 24 }, void 0)] }, void 0) }), void 0));
}
...
function ButtonDropdownLight(_a) {
    var { disabled = false, children } = _a, rest = __rest(_a, ["disabled", "children"]);
    return ((0, jsx_runtime_1.jsx)(exports.ButtonOutlined, Object.assign({}, rest, { disabled: disabled }, { children: (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ style: { display: 'flex', alignItems: 'center' } }, { children: children }), void 0), (0, jsx_runtime_1.jsx)(react_feather_1.ChevronDown, { size: 24 }, void 0)] }, void 0) }), void 0));
}
exports.ButtonDropdownLight = ButtonDropdownLight;
function ButtonRadio(_a) {
    var { active } = _a, rest = __rest(_a, ["active"]);
    if (!active) {
        return (0, jsx_runtime_1.jsx)(exports.ButtonWhite, Object.assign({}, rest), void 0);
    }
    else {
        return (0, jsx_runtime_1.jsx)(exports.ButtonPrimary, Object.assign({}, rest), void 0);
    }
