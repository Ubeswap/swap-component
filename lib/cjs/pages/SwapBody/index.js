...
function SwapBody({ accountInfo, theme: swapTheme, defaultSwapToken, defaultTokenLists, minimaPartnerId, onConnectWallet, }) {
    ...
    (0, react_1.useEffect)(() => {
        dispatch((0, actions_1.setAccountInfo)({ accountInfo: accountInfo }));
