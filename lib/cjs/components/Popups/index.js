...
function Popups() {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(FixedPopupColumn, Object.assign({ gap: "20px", extraPadding: urlWarningActive }, { children: activePopups.map((item) => ((0, jsx_runtime_1.jsx)(PopupItem_1.default, { content: item.content, popKey: item.key, removeAfterMs: item.removeAfterMs }, item.key))) }), void 0), (0, jsx_runtime_1.jsx)(MobilePopupWrapper, Object.assign({ height: (activePopups === null || activePopups === void 0 ? void 0 : activePopups.length) > 0 ? 'fit-content' : 0 }, { children: (0, jsx_runtime_1.jsx)(MobilePopupInner, { children: activePopups // reverse so new items up front
                        .slice(0)
                        .reverse()
                        .map((item) => ((0, jsx_runtime_1.jsx)(PopupItem_1.default, { content: item.content, popKey: item.key, removeAfterMs: item.removeAfterMs }, item.key))) }, void 0) }), void 0)] }, void 0));
}
