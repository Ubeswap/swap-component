...
function CurrencyLogo({ currency, size = '24px', style, }) {
    ...
    return (0, jsx_runtime_1.jsx)(StyledLogo, { size: size, srcs: srcs, alt: `${(_a = currency === null || currency === void 0 ? void 0 : currency.symbol) !== null && _a !== void 0 ? _a : 'token'} logo`, style: style }, void 0);
}
