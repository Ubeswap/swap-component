...
function Slider({ value, onChange, min = 0, step = 1, max = 100, size = 28 }) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledRangeInput, { size: size, type: "range", value: value, style: { width: '90%', marginLeft: 15, marginRight: 15, padding: '15px 0' }, onChange: changeCallback, "aria-labelledby": "input slider", step: step, min: min, max: max }));
}
