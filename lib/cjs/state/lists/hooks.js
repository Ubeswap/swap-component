 ...
 */
const EMPTY_LIST = {
    [use_contractkit_1.ChainId.Mainnet]: {},
...
function combineMaps(map1, map2) {
    return {
        [use_contractkit_1.ChainId.Mainnet]: Object.assign(Object.assign({}, map1[use_contractkit_1.ChainId.Mainnet]), map2[use_contractkit_1.ChainId.Mainnet]),
...
function useCombinedActiveList(defaultTokenLists) {
    const activeListUrls = useActiveListUrls();
    const activeTokens = useCombinedTokenMapFromUrls(defaultTokenLists ? undefined : activeListUrls);
    const defaultTokenMap = listToTokenMap(defaultTokenLists
        ? Object.assign(Object.assign({}, default_token_list_1.default), { tokens: defaultTokenLists }) : Object.assign(Object.assign({}, default_token_list_1.default), default_token_list_2.default));
