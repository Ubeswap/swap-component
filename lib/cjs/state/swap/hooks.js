...
function useDerivedSwapInfo() {
    ...
    const bestTradeExactIn = (0, useTrade_1.useUbeswapTradeExactIn)(isExactIn ? parsedAmount : undefined, outputCurrency !== null && outputCurrency !== void 0 ? outputCurrency : undefined);
...
function parseCurrencyFromURLParameter(urlParam, chainId) {
    ...
    if ([use_contractkit_1.ChainId.EthereumMainnet, use_contractkit_1.ChainId.Kovan].includes(chainId)) {
        return '';
    }
