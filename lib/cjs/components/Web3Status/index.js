...
const StatusIcon = () => {
    ...
    if (walletType === use_contractkit_1.WalletTypes.MetaMask ||
        ...
        return (0, jsx_runtime_1.jsx)(Identicon_1.default, {});
    }
    return null;
};
function Web3StatusInner() {
    ...
    if (accountName) {
        return ((0, jsx_runtime_1.jsxs)(Web3StatusConnected, Object.assign({ id: "web3-status-connected", onClick: toggleWalletModal, pending: hasPendingTransactions }, { children: [hasPendingTransactions ? ((0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Text, { children: [pending === null || pending === void 0 ? void 0 : pending.length, " ", t('pending')] }), ' ', (0, jsx_runtime_1.jsx)(Loader_1.default, { stroke: "white" })] })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(Text, { children: accountName }) })), !hasPendingTransactions && (0, jsx_runtime_1.jsx)(StatusIcon, {})] })));
    }
    else if (error) {
        return ((0, jsx_runtime_1.jsxs)(Web3StatusError, Object.assign({ onClick: () => connect().catch(console.warn) }, { children: [(0, jsx_runtime_1.jsx)(NetworkIcon, {}), (0, jsx_runtime_1.jsx)(Text, { children: error === 'unsupported' ? 'Wrong Network' : 'Error' })] })));
    }
    else {
        return ((0, jsx_runtime_1.jsx)(Web3StatusConnect, Object.assign({ id: "connect-wallet", onClick: () => connect().catch(console.warn), faded: !address }, { children: (0, jsx_runtime_1.jsx)(Text, { children: t('ConnectToAWallet') }) })));
    }
}
function Web3Status() {
    var _a;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Web3StatusInner, {}), (0, jsx_runtime_1.jsx)(WalletModal_1.default, { ENSName: (_a = nom !== null && nom !== void 0 ? nom : summary === null || summary === void 0 ? void 0 : summary.name) !== null && _a !== void 0 ? _a : undefined, pendingTransactions: pending, confirmedTransactions: confirmed })] }));
}
