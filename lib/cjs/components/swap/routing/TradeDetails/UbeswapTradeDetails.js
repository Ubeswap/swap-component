...
const UbeswapTradeDetails = ({ trade, allowedSlippage }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, fontWeight: 400, color: theme.text2 }, { children: isExactIn ? 'Minimum received' : 'Maximum sold' })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "Your transaction will revert if there is a large, unfavorable price movement before it is confirmed." })] }), (0, jsx_runtime_1.jsx)(Row_1.RowFixed, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ color: theme.text1, fontSize: 14 }, { children: isExactIn
                                ...
                                : (_d = `${(_c = slippageAdjustedAmounts[actions_1.Field.INPUT]) === null || _c === void 0 ? void 0 : _c.toSignificant(4)} ${trade.inputAmount.currency.symbol}`) !== null && _d !== void 0 ? _d : '-' })) })] }), (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsxs)(Row_1.RowFixed, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.black, Object.assign({ fontSize: 14, fontWeight: 400, color: theme.text2 }, { children: "Price Impact" })), (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: "The difference between the market price and estimated price due to trade size." })] }), (0, jsx_runtime_1.jsx)(FormattedPriceImpact_1.default, { priceImpact: priceImpactWithoutFee })] })] }));
};
