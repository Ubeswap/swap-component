...
function AccountDetails({ toggleWalletModal, pendingTransactions, confirmedTransactions, ENSName, }) {
    ...
    function formatConnectorName() {
        ...
        return ((0, jsx_runtime_1.jsxs)(WalletName, { children: [t('ConnectedWith'), " ", walletType] }));
    }
    function getStatusIcon() {
        if (walletType === use_contractkit_1.WalletTypes.MetaMask) {
            return ((0, jsx_runtime_1.jsx)(IconWrapper, Object.assign({ size: 16 }, { children: (0, jsx_runtime_1.jsx)(Identicon_1.default, {}) })));
        }
        return null;
    }
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(UpperSection, { children: [(0, jsx_runtime_1.jsx)(CloseIcon, Object.assign({ onClick: toggleWalletModal }, { children: (0, jsx_runtime_1.jsx)(CloseColor, {}) })), (0, jsx_runtime_1.jsx)(HeaderRow, { children: "Account" }), (0, jsx_runtime_1.jsx)(AccountSection, { children: (0, jsx_runtime_1.jsx)(YourAccount, { children: (0, jsx_runtime_1.jsxs)(InfoCard, { children: [(0, jsx_runtime_1.jsxs)(AccountGroupingRow, { children: [formatConnectorName(), (0, jsx_runtime_1.jsxs)("div", { children: [address && ((0, jsx_runtime_1.jsx)(WalletAction, Object.assign({ style: { fontSize: '.825rem', fontWeight: 400, marginRight: '8px' }, onClick: destroy }, { children: t('Disconnect') }))), (0, jsx_runtime_1.jsx)(WalletAction, Object.assign({ style: { fontSize: '.825rem', fontWeight: 400 }, onClick: () => {
                                                            closeModals();
                                                            connect();
                                                        } }, { children: t('Change') }))] })] }), (0, jsx_runtime_1.jsx)(AccountGroupingRow, Object.assign({ id: "web3-account-identifier-row" }, { children: (0, jsx_runtime_1.jsx)(AccountControl, { children: (0, jsx_runtime_1.jsxs)("div", { children: [getStatusIcon(), ENSName ? (0, jsx_runtime_1.jsxs)("p", { children: [" ", ENSName] }) : (0, jsx_runtime_1.jsxs)("p", { children: [" ", address && (0, utils_1.shortenAddress)(address)] })] }) }) })), (0, jsx_runtime_1.jsx)(AccountGroupingRow, { children: ENSName ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(AccountControl, { children: (0, jsx_runtime_1.jsxs)("div", { children: [address && ((0, jsx_runtime_1.jsx)(Copy_1.default, Object.assign({ toCopy: address }, { children: (0, jsx_runtime_1.jsx)("span", Object.assign({ style: { marginLeft: '4px' } }, { children: t('CopyAddress') })) }))), chainId && address && ((0, jsx_runtime_1.jsxs)(AddressLink, Object.assign({ hasENS: !!ENSName, isENS: true, href: `${network.explorer}/address/${address}` }, { children: [(0, jsx_runtime_1.jsx)(react_feather_1.ExternalLink, { size: 16 }), (0, jsx_runtime_1.jsx)("span", Object.assign({ style: { marginLeft: '4px' } }, { children: t('ViewOnCeloExplorer') }))] })))] }) }) })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(AccountControl, { children: (0, jsx_runtime_1.jsxs)("div", { children: [address && ((0, jsx_runtime_1.jsx)(Copy_1.default, Object.assign({ toCopy: address }, { children: (0, jsx_runtime_1.jsx)("span", Object.assign({ style: { marginLeft: '4px' } }, { children: t('CopyAddress') })) }))), chainId && address && ((0, jsx_runtime_1.jsxs)(AddressLink, Object.assign({ hasENS: !!ENSName, isENS: false, href: `${network.explorer}/address/${address}` }, { children: [(0, jsx_runtime_1.jsx)(react_feather_1.ExternalLink, { size: 16 }), (0, jsx_runtime_1.jsx)("span", Object.assign({ style: { marginLeft: '4px' } }, { children: t('ViewOnCeloExplorer') }))] })))] }) }) })) })] }) }) })] }), !!pendingTransactions.length || !!confirmedTransactions.length ? ((0, jsx_runtime_1.jsxs)(LowerSection, { children: [(0, jsx_runtime_1.jsxs)(Row_1.AutoRow, Object.assign({ mb: '1rem', style: { justifyContent: 'space-between' } }, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.body, { children: t('RecentTransactions') }), (0, jsx_runtime_1.jsxs)(theme_1.LinkStyledButton, Object.assign({ onClick: clearAllTransactionsCallback }, { children: ["(", t('ClearAll'), ")"] }))] })), renderTransactions(pendingTransactions), renderTransactions(confirmedTransactions)] })) : ((0, jsx_runtime_1.jsx)(LowerSection, { children: (0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ color: theme.text1 }, { children: t('YourTransactionsWillAppearHere') })) }))] }));
}
