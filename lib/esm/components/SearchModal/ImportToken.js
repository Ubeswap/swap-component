...
export function ImportToken({ tokens, onBack, onDismiss, handleCurrencySelect }) {
    ...
    return (_jsxs(Wrapper, { children: [_jsx(PaddedColumn, Object.assign({ gap: "14px", style: { width: '100%', flex: '1 1' } }, { children: _jsxs(RowBetween, { children: [onBack ? _jsx(ArrowLeft, { style: { cursor: 'pointer' }, onClick: onBack }, void 0) : _jsx("div", {}, void 0), _jsxs(TYPE.mediumHeader, { children: [t('Import'), " ", tokens.length > 1 ? `${t('Tokens')}` : `${t('Token')}`] }, void 0), onDismiss ? _jsx(CloseIcon, { onClick: onDismiss }, void 0) : _jsx("div", {}, void 0)] }, void 0) }), void 0), _jsx(SectionBreak, {}, void 0), _jsxs(PaddedColumn, Object.assign({ gap: "md" }, { children: [tokens.map((token) => {
                        var _a, _b;
                        ...
                        return (_jsx(Card, Object.assign({ backgroundColor: theme.bg2, className: ".token-warning-container" }, { children: _jsxs(AutoColumn, Object.assign({ gap: "10px" }, { children: [_jsxs(AutoRow, Object.assign({ align: "center" }, { children: [_jsx(CurrencyLogo, { currency: token, size: '24px' }, void 0), _jsx(TYPE.body, Object.assign({ ml: "8px", mr: "8px", fontWeight: 500 }, { children: token.symbol }), void 0), _jsx(TYPE.darkGray, Object.assign({ fontWeight: 300 }, { children: token.name }), void 0)] }), void 0), chainId && (_jsx(ExternalLink, Object.assign({ href: `${network.explorer}/address/${token.address}` }, { children: _jsx(AddressText, { children: token.address }, void 0) }), void 0)), list !== undefined ? (_jsxs(RowFixed, { children: [list.logoURI && _jsx(ListLogo, { logoURI: list.logoURI, size: "12px" }, void 0), _jsxs(TYPE.small, Object.assign({ ml: "6px", color: theme.text3 }, { children: ["via ", list.name] }), void 0)] }, void 0)) : (_jsx(WarningWrapper, Object.assign({ borderRadius: "4px", padding: "4px", highWarning: true }, { children: _jsxs(RowFixed, { children: [_jsx(AlertTriangle, { stroke: theme.red1, size: "10px" }, void 0), _jsx(TYPE.body, Object.assign({ color: theme.red1, ml: "4px", fontSize: "10px", fontWeight: 500 }, { children: t('UnknownSource') }), void 0)] }, void 0) }), void 0))] }), void 0) }), 'import' + token.address));
                    }), _jsxs(Card, Object.assign({ style: { backgroundColor: fromLists ? transparentize(0.8, theme.yellow2) : transparentize(0.8, theme.red1) } }, { children: [_jsxs(AutoColumn, Object.assign({ justify: "center", style: { textAlign: 'center', gap: '16px', marginBottom: '12px' } }, { children: [_jsx(AlertTriangle, { stroke: fromLists ? theme.yellow2 : theme.red1, size: 32 }, void 0), _jsx(TYPE.body, Object.assign({ fontWeight: 600, fontSize: 20, color: fromLists ? theme.yellow2 : theme.red1 }, { children: t('TradeAtYourOwnRisk') }), void 0)] }), void 0), _jsxs(AutoColumn, Object.assign({ style: { textAlign: 'center', gap: '16px', marginBottom: '12px' } }, { children: [_jsx(TYPE.body, Object.assign({ fontWeight: 400, color: fromLists ? theme.yellow2 : theme.red1 }, { children: t('tokenExp') }), void 0), _jsx(TYPE.body, Object.assign({ fontWeight: 600, color: fromLists ? theme.yellow2 : theme.red1 }, { children: t('tokenImportRisk') }), void 0)] }), void 0), _jsxs(AutoRow, Object.assign({ justify: "center", style: { cursor: 'pointer' }, onClick: () => setConfirmed(!confirmed) }, { children: [_jsx(Checkbox, { className: ".understand-checkbox", name: "confirmed", type: "checkbox", checked: confirmed, onChange: () => setConfirmed(!confirmed) }, void 0), _jsx(TYPE.body, Object.assign({ ml: "10px", fontSize: "16px", color: fromLists ? theme.yellow2 : theme.red1, fontWeight: 500 }, { children: t('IUnderstand') }), void 0)] }), void 0)] }), void 0), _jsx(ButtonPrimary, Object.assign({ disabled: !confirmed, altDisabledStyle: true, borderRadius: "20px", padding: "10px 1rem", onClick: () => {
