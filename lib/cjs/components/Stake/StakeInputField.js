...
function StakeInputField({ value, onUserInput, onMax, currency, hideBalance = false, hideInput = false, id, stakeBalance, walletBalance, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(InputPanel, Object.assign({ id: id }, { children: (0, jsx_runtime_1.jsxs)(Container, Object.assign({ hideInput: hideInput }, { children: [!hideInput && ((0, jsx_runtime_1.jsx)(LabelRow, { children: (0, jsx_runtime_1.jsx)(AmountWrapper, { children: account && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(AmountDescriptionWrapper, { children: [(0, jsx_runtime_1.jsx)("span", { children: "Current Stake:\u00A0" }), (0, jsx_runtime_1.jsx)("span", { children: stakeBalance ? stakeBalance.toFixed(2, { groupSeparator: ',' }) : '--' })] }), (0, jsx_runtime_1.jsxs)(AmountDescriptionWrapper, { children: [(0, jsx_runtime_1.jsx)("span", { children: "Wallet Balance:\u00A0 " }), (0, jsx_runtime_1.jsx)("span", { children: !hideBalance && !!currency && selectedCurrencyBalance
                                                ? selectedCurrencyBalance === null || selectedCurrencyBalance === void 0 ? void 0 : selectedCurrencyBalance.toSignificant(4)
                                                : '--' })] })] })) }) })), (0, jsx_runtime_1.jsx)(InputRow, Object.assign({ style: { marginTop: '-0.5rem' }, selected: true }, { children: !hideInput && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(NumericalInput_1.Input, { className: "token-amount-input", value: value, onUserInput: (val) => {
                                    onUserInput(val);
                                } }), (0, jsx_runtime_1.jsx)(ButtonGroup, { children: (0, jsx_runtime_1.jsx)(StyledControlButton, Object.assign({ onClick: onMax }, { children: "MAX" })) })] })) }))] })) })));
}
