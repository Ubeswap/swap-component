...
function TransactionPopup({ hash, success, summary, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(RowNoFlex, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ style: { paddingRight: 16 } }, { children: success ? (0, jsx_runtime_1.jsx)(react_feather_1.CheckCircle, { color: theme.green1, size: 24 }, void 0) : (0, jsx_runtime_1.jsx)(react_feather_1.AlertCircle, { color: theme.red1, size: 24 }, void 0) }), void 0), (0, jsx_runtime_1.jsxs)(Column_1.AutoColumn, Object.assign({ gap: "8px" }, { children: [(0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ fontWeight: 500 }, { children: summary !== null && summary !== void 0 ? summary : `${t('Hash')}: ` + hash.slice(0, 8) + '...' + hash.slice(58, 65) }), void 0), chainId && (0, jsx_runtime_1.jsx)(components_1.ExternalLink, Object.assign({ href: `${network.explorer}/tx/${hash}` }, { children: t('ViewOnCeloExplorer') }), void 0)] }), void 0)] }, void 0));
}
