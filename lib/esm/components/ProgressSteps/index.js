...
export default function ProgressCircles(_a) {
    ...
    return (_jsx(Wrapper, Object.assign({ justify: 'center' }, rest, { children: _jsxs(Grouping, { children: [steps.map((step, i) => {
                    return (_jsxs(CircleRow, { children: [_jsx(Circle, Object.assign({ confirmed: step, disabled: disabled || (!steps[i - 1] && i !== 0) }, { children: step ? '✓' : i + 1 })), _jsx(Connector, { prevConfirmed: step, disabled: disabled })] }, i));
                }), _jsx(Circle, Object.assign({ disabled: disabled || !steps[steps.length - 1] }, { children: steps.length + 1 }))] }) })));
}
