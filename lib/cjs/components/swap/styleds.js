...
function SwapCallbackError({ error }) {
    return ((0, jsx_runtime_1.jsxs)(SwapCallbackErrorInner, { children: [(0, jsx_runtime_1.jsx)(SwapCallbackErrorInnerAlertTriangle, { children: (0, jsx_runtime_1.jsx)(react_feather_1.AlertTriangle, { size: 24 }) }), (0, jsx_runtime_1.jsx)("p", { children: error })] }));
}
