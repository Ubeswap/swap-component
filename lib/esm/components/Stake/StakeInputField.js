...
export default function StakeInputField({ value, onUserInput, onMax, currency, hideBalance = false, hideInput = false, id, stakeBalance, walletBalance, }) {
    ...
    return (_jsx(InputPanel, Object.assign({ id: id }, { children: _jsxs(Container, Object.assign({ hideInput: hideInput }, { children: [!hideInput && (_jsx(LabelRow, { children: _jsx(AmountWrapper, { children: account && (_jsxs(_Fragment, { children: [_jsxs(AmountDescriptionWrapper, { children: [_jsx("span", { children: "Current Stake:\u00A0" }), _jsx("span", { children: stakeBalance ? stakeBalance.toFixed(2, { groupSeparator: ',' }) : '--' })] }), _jsxs(AmountDescriptionWrapper, { children: [_jsx("span", { children: "Wallet Balance:\u00A0 " }), _jsx("span", { children: !hideBalance && !!currency && selectedCurrencyBalance
                                                ? selectedCurrencyBalance === null || selectedCurrencyBalance === void 0 ? void 0 : selectedCurrencyBalance.toSignificant(4)
                                                : '--' })] })] })) }) })), _jsx(InputRow, Object.assign({ style: { marginTop: '-0.5rem' }, selected: true }, { children: !hideInput && (_jsxs(_Fragment, { children: [_jsx(NumericalInput, { className: "token-amount-input", value: value, onUserInput: (val) => {
                                    onUserInput(val);
                                } }), _jsx(ButtonGroup, { children: _jsx(StyledControlButton, Object.assign({ onClick: onMax }, { children: "MAX" })) })] })) }))] })) })));
}
