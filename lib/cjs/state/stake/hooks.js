...
const useMultiRewardPools = () => {
    ...
    const call = react_1.default.useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(farmSummaries.map((fs) => __awaiter(void 0, void 0, void 0, function* () {
            let poolContract = generated_1.MoolaStakingRewards__factory.connect(fs.stakingAddress, library);
            const rewardsTokens = [];
            ...
            while (!baseContractFound) {
                try {
                    ...
                    poolContract = generated_1.MoolaStakingRewards__factory.connect(externalStakingRewardAddr, library);
                    rewardsTokens.push(yield poolContract.rewardsToken());
...
const useUnclaimedStakingRewards = () => {
    ...
    const poolManagerContract = (0, useContract_1.usePoolManagerContract)([use_contractkit_1.ChainId.CeloMainnet, use_contractkit_1.ChainId.Alfajores].includes(chainId) ? poolManager_1.POOL_MANAGER[chainId] : undefined);
