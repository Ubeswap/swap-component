...
`;
function CurrencySearch({ selectedCurrency, onCurrencySelect, otherSelectedCurrency, showCommonBases, onDismiss, isOpen, showManageView, showImportView, setImportToken, chainId = use_contractkit_1.ChainId.Mainnet, defaultTokenLists, }) {
    ...
    const allTokens = (0, Tokens_1.useAllTokens)(chainId, defaultTokenLists);
