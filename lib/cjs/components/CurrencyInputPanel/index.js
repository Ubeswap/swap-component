...
`;
const StyledDropDown = (0, styled_components_1.default)(dropdown_svg_1.ReactComponent) `
...
hideInput = false, otherCurrency, id, showCommonBases, customBalanceText, chainId, balanceOverride, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(InputPanel, Object.assign({ id: id }, { children: [(0, jsx_runtime_1.jsxs)(Container, Object.assign({ hideInput: hideInput }, { children: [!hideInput && ((0, jsx_runtime_1.jsx)(LabelRow, { children: (0, jsx_runtime_1.jsxs)(Row_1.RowBetween, { children: [(0, jsx_runtime_1.jsx)(CurrencySelect_1.CurrencySelect, Object.assign({ selected: !!currency, className: "open-currency-select-button", onClick: () => {
                                    ...
                                    } }, { children: (0, jsx_runtime_1.jsxs)(Aligner, { children: [pair ? ((0, jsx_runtime_1.jsx)(DoubleLogo_1.default, { currency0: pair.token0, currency1: pair.token1, size: 24, margin: true }, void 0)) : currency ? ((0, jsx_runtime_1.jsx)(CurrencyLogo_1.default, { currency: currency, size: '24px' }, void 0)) : null, pair ? ((0, jsx_runtime_1.jsxs)(StyledTokenName, Object.assign({ className: "pair-name-container" }, { children: [pair === null || pair === void 0 ? void 0 : pair.token0.symbol, ":", pair === null || pair === void 0 ? void 0 : pair.token1.symbol] }), void 0)) : ((0, jsx_runtime_1.jsx)(StyledTokenName, Object.assign({ className: "token-symbol-container", active: Boolean(currency && currency.symbol) }, { children: (currency && currency.symbol && currency.symbol.length > 20
                                                    ? currency.symbol.slice(0, 4) +
                                                        '...' +
                                                        currency.symbol.slice(currency.symbol.length - 5, currency.symbol.length)
                                                    : currency === null || currency === void 0 ? void 0 : currency.symbol) || t('selectToken') }), void 0)), !disableCurrencySelect && (0, jsx_runtime_1.jsx)(StyledDropDown, { selected: !!currency }, void 0)] }, void 0) }), void 0), account && ((0, jsx_runtime_1.jsx)(theme_1.TYPE.body, Object.assign({ onClick: onMax, color: theme.text2, fontWeight: 500, fontSize: 14, style: { display: 'inline', cursor: 'pointer' } }, { children: !hideBalance && !!currency && selectedCurrencyBalance
                                        ...
                                        : ' -' }), void 0))] }, void 0) }, void 0)), (0, jsx_runtime_1.jsx)(InputRow, Object.assign({ style: hideInput ? { padding: '0', borderRadius: '8px' } : {}, selected: disableCurrencySelect }, { children: !hideInput && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(NumericalInput_1.Input, { className: "token-amount-input", value: value, onUserInput: (val) => {
                                        onUserInput(val);
                                    } }, void 0), account && currency && label !== 'To' && ((0, jsx_runtime_1.jsxs)(ButtonGroup, { children: [showHalfButton && (0, jsx_runtime_1.jsx)(StyledControlButton, Object.assign({ onClick: onHalf }, { children: "50%" }), void 0), showMaxButton && (0, jsx_runtime_1.jsx)(StyledControlButton, Object.assign({ onClick: onMax }, { children: "MAX" }), void 0)] }, void 0))] }, void 0)) }), void 0)] }), void 0), !disableCurrencySelect && onCurrencySelect && ((0, jsx_runtime_1.jsx)(CurrencySearchModal_1.default, { isOpen: modalOpen, onDismiss: handleDismissSearch, onCurrencySelect: onCurrencySelect, selectedCurrency: currency, otherSelectedCurrency: otherCurrency, showCommonBases: showCommonBases, chainId: chainId }, void 0))] }), void 0));
}
