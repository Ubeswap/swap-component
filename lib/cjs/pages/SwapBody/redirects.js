...
function RedirectPathToSwapOnly({ location }) {
    return (0, jsx_runtime_1.jsx)(react_router_dom_1.Redirect, { to: Object.assign(Object.assign({}, location), { pathname: '/swap' }) });
}
...
function OpenClaimAddressModalAndRedirectToSwap(props) {
    ...
    return (0, jsx_runtime_1.jsx)(RedirectPathToSwapOnly, Object.assign({}, props));
}
