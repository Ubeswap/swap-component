...
export function useCUSDPrices(tokens) {
    const { network: { chainId }, } = useContractKit();
    const CUSD = cUSD[chainId];
    const celo = CELO[chainId];
    const tokenPairs = useMemo(() => tokens === null || tokens === void 0 ? void 0 : tokens.map((token) => [
...
export const useCUSDPriceOfULP = (stakingToken) => {
    ...
    const token0Address = (_b = (_a = useSingleCallResult(pair, 'token0', [])) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b[0];
    const token1Address = (_d = (_c = useSingleCallResult(pair, 'token1', [])) === null || _c === void 0 ? void 0 : _c.result) === null || _d === void 0 ? void 0 : _d[0];
