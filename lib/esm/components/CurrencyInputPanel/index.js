...
hideInput = false, otherCurrency, id, showCommonBases, customBalanceText, chainId, balanceOverride, disabled = false, defaultTokenLists, defaultTokenLogoURI, }) {
    ...
    return (_jsxs(InputPanel, Object.assign({ id: id }, { children: [_jsxs(Container, Object.assign({ hideInput: hideInput }, { children: [!hideInput && (_jsx(LabelRow, { children: _jsxs(RowBetween, { children: [_jsx(CurrencySelect, Object.assign({ selected: !!currency, disableCurrencySelect: disableCurrencySelect, className: "open-currency-select-button", onClick: () => {
                                        if (!disableCurrencySelect) {
                                            setModalOpen(true);
                                        }
                                    } }, { children: _jsxs(Aligner, { children: [pair ? (_jsx(DoubleCurrencyLogo, { currency0: pair.token0, currency1: pair.token1, size: 24, margin: true })) : currency ? (_jsx(CurrencyLogo, { currency: currency, size: '24px', defaultTokenLogoURI: defaultTokenLogoURI })) : null, pair ? (_jsxs(StyledTokenName, Object.assign({ className: "pair-name-container" }, { children: [pair === null || pair === void 0 ? void 0 : pair.token0.symbol, ":", pair === null || pair === void 0 ? void 0 : pair.token1.symbol] }))) : (_jsx(StyledTokenName, Object.assign({ className: "token-symbol-container", active: Boolean(currency && currency.symbol) }, { children: (currency && currency.symbol && currency.symbol.length > 20
