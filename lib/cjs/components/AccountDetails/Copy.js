...
function CopyHelper(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(CopyIcon, Object.assign({ onClick: () => setCopied(props.toCopy) }, { children: [isCopied ? ((0, jsx_runtime_1.jsxs)(TransactionStatusText, { children: [(0, jsx_runtime_1.jsx)(react_feather_1.CheckCircle, { size: '16' }), (0, jsx_runtime_1.jsxs)(TransactionStatusText, { children: [" ", t('copied'), " "] })] })) : ((0, jsx_runtime_1.jsx)(TransactionStatusText, { children: (0, jsx_runtime_1.jsx)(react_feather_1.Copy, { size: '16' }) })), isCopied ? '' : props.children] })));
}
